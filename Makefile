...
prep_git:
	...
	@read reply
	@echo "  * Create a new repository in the RADICAL project named 'radical.xgfabric' at"
	...
	@echo "        git remote add origin git@github.com:radical-cybertools/radical.xgfabric.git"
	@echo "        git push origin master"
	@read reply
	@echo "  * Check the README content on "
	@echo "        https://github.com/radical-cybertools/radical.xgfabric"
	@read reply
	@echo "  * Make sure to 'watch' that repository (button on upper right)"
	@read reply
	@echo "  * Use the issue tracker on github, at "
	@echo "        https://github.com/radical-cybertools/radical.xgfabric/issues"
	@read reply
...
prep_pypi:
	...
	@echo "      * install your package from pypi, via 'pip install --upgrade radical.xgfabric'"
	@echo "      * ensure basic functionality, eg. via 'radical-xgfabric-version'"
	@read reply
...
prep_rtd:
	...
	@echo "      * name     : radical.xgfabric"
	@echo "      * git url  : https://github.com/radical-cybertools/radical.xgfabric.git"
	@echo "      * doc type : sphinx"
	@echo "      * home page: https://github.com/radical-cybertools/radical.xgfabric/"
	@read reply
	@echo
...
prep_jenkins:
	...
	@read reply
	@echo "  * In the job configuration, search for 'utils' and replace with 'xgfabric'."
	@read reply
